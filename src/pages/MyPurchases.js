...
export const MyPurchases = () => {
    ...
    const get_purchases = async () => {
        try {
            ...
            const response = await fetch(
                `http://backec.eastus.cloudapp.azure.com/GET-PURCHASES/?user_id=${user.sub}`,
                {
                    method: "GET",
                    headers: {
    ...
    const removepurchases = async (id) => {
        try {
            ...
            const token = accessToken.__raw;
            await fetch(
                "http://backec.eastus.cloudapp.azure.com/CANCEL_PURCHASE/?id_purchase=" +
                id,
                {
                    method: "DELETE",
                    headers: {
    ...
    return (
        <main>
            <div className="grid-container-purchase">
                <h1 className="title-purchase"> My Purchases</h1>
